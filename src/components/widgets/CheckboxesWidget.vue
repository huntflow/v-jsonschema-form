<script>
    ...
    export default {
        ...
        methods: {
            isDisabled(option) {
                const itemDisabled = this.options.enumDisabled &&
                    this.options.enumDisabled.indexOf(option.value) != -1;
        ...
        render(h) {
            ...
            const makeCheckbox = ({ index, option, }) => h('span', {}, [
                h('input', {
                    on: {
                        change: event => {
            ...
            return h('div', { attrs: { id, }, }, [
                ...
                ...enumOptions.map((option, index) => {
                    const disabledCls = this.isDisabled(option)
                        ? 'disabled'
                        : '';
