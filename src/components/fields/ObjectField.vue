<template>
    ...
    >
        <component
            ...
            :ui-schema="isAddedByAdditionalProperties(propName) ? uiSchema.additionalProperties : uiSchema[propName]"
    ...
    export default {
        ...
        computed: {
            ...
            title() {
                ...
                // otherwise
                return this.retrivedSchema.title === undefined
                    ? this.name
                    : this.retrivedSchema.title;
            },
            description() {
                return (
